...
namespace LegacyCommandHandler
{
    internal class CommandFilter : IOleCommandTarget
    {
        ...
        /// Command ID.
        /// </summary>
        public const int ReplaceCommandId = 0x0100;

        /// <summary>
        /// Command menu group (command set GUID).
        /// </summary>
        public static readonly Guid ReplaceCommandSet = new Guid("4fd0ea18-9f33-43da-ace0-e387656e584c");

        public int QueryStatus(ref Guid pguidCmdGroup, uint cCmds, OLECMD[] prgCmds, IntPtr pCmdText)
        {
            if (pguidCmdGroup == ReplaceCommandSet && cCmds == 1 && prgCmds[0].cmdID == ReplaceCommandId)
            {
